				...
				<section class="text-white px-8 py-6 flex flex-col items-center">
					<div>
						<div class="flex justify-between items-center">
							...
							<button class="px-4 py-2 border border-pig hover:bg-lightSmoke text-cta bg-coal" @click="scrollaaOtteluohjelmaan">
						...
						<div class="pt-6" v-if="onKirjautunut">
							<div class="mb-4 flex items-center">
								...
								<button class="px-4 text-cta py-1 mr-4 border border-pig hover:bg-lightSmoke bg-coal" @click="lisaaTulos('voitto', +1)">
									Voitto
								</button>
								<button class="px-4 text-cta py-1 border border-pig hover:bg-lightSmoke bg-coal" @click="lisaaTulos('tasapeli', +1)">
									Tasapeli
								</button>
								<button class="px-4 text-cta py-1 mx-4 border border-pig hover:bg-lightSmoke bg-coal" @click="lisaaTulos('havio', +1)">
									Häviö
								</button>
							</div>
							<div class="mb-4 flex items-center">
								...
								<div v-if="naytaTulosModal" class="fixed inset-0 flex items-center justify-center">
									<div class="bg-coal text-white p-12 rounded-md shadow-xl shadow-black w-1/3">
										...
										<div class="flex items-center mb-4">
											<input
												type="number"
												class="w-12 mr-2 px-1 py-1 border border-pig rounded-md bg-smoke"
											...
											<input
												type="number"
												class="w-12 ml-2 px-1 py-1 border border-pig rounded-md bg-smoke"
				...
				<div>
					<div class="mb-6">
						...
						<ul>
							<li v-for="item in tallennetutTiedot" :key="item.id" class="flex justify-between items-center">
								...
								<button
									class="px-2 py-1 bg-red-500 text-white border border-pig hover:bg-red-700 mb-2"
									v-if="onKirjautunut"
									@click="poistaTeksti(item.id)"
								>
									Poista
								</button>
							</li>
					...
					<div class="mb-6" v-if="onKirjautunut">
						...
						<input
							type="text"
							v-model="uusiTeksti"
							class="w-1/2 mr-4 bg-coal text-white border border-pig p-2 mb-4"
